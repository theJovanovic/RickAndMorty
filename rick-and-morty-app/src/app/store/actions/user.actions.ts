...
export const registerUserSuccess = createAction('[User] Register User Success', props<{ token: string }>());
...
export const loginUserSuccess = createAction('[User] Login User Success', props<{ token: string }>());
